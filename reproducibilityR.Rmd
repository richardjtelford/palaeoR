...
```{r child = "child_rmd/useAnIDE.Rmd"}
```

# You need a style guide {.section}

```{r child = "child_rmd/styleguide.Rmd"}
```

# Importing data {.section}

```{r child = "child_rmd/data_importing.Rmd"}
```


# Tidyverse {.section}

```{r child = "child_rmd/pipes.Rmd"}
```
...
```{r child = "child_rmd/regular_expressions.Rmd"}
```

# Dates and times {.section}

```{r child = "child_rmd/lubridate.Rmd"}
```


# Dependency management {.section}

```{r child = "child_rmd/dependencyManagement.Rmd"}
``` 
...
[stat545.com](https://stat545.com/) Data wrangling, exploration, and analysis with R [stat545.com](https://stat545.com/)